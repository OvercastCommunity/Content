...
- The map pool has yet to be confirmed and will be announced at a later date.

# Servers and scrims

- You will be able to scrimmage other teams using [OCC PUGs](https://oc.tc/pugs).
- Alternatively, a community server, [Fireballs](https://discord.gg/pUzcGwKsmj), also hosts scrimmages and other events.

# Prize pool

*This is not final and it's subject to change*

- **1st Place**: Tournament Winner rank (3 months), a website trophy, 25,000 raindrops, and 5 sponsor tokens
- **2nd Place**: 15,000 raindrops and 3 sponsor tokens
- All participants: 5,000 raindrops and 1 sponsor token

# Rules

Overcast Community [rules](https://oc.tc/rules) will apply, and any player found breaking them during the tournament will be punished accordingly.
